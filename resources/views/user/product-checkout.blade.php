                ...
                <div class="row">
                    <form class="row contact_form" action="{{ route('place.order') }}" method="post">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="col-md-12 form-group p_star">
                                <select class="country_select" id="province_select" name="province_select" data-width="100%">
                            ...
                            <div class="col-md-12 form-group p_star">
                                <select class="country_select" id="district_select" name="district_select" data-width="100%">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select class="country_select mb-4" name="shippingOption" id="shippingOption" onchange="updateShippingCost()">
                                    ...
                                    <table class="order_table">
                                        ...
                                        @foreach ($checkoutItems as $checkoutItem)
                                            <tr>
                                                ...
                                                <td style="width: 30%; text-align: right;">${{ $checkoutItem->total }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </table>
